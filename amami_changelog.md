...
- microG build only: AOSmium System Webview 147.0.7727.49
- microG build only: microG GmsCore & companion v0.3.14.250932
- microG build only: Fix of a microG companion regression
...
- microG build only: AOSmium System Webview 143.0.7499.109
- microG build only: microG GmsCore & companion v0.3.11.250932
...
- standard build only: System Webview 122.0.6261.119
- microG build only: Mulch Webview 123.0.6312.99


10.03.2024

- Custom build release 2024-03-01
- standard build only: System Webview 122.0.6261.90
- microG build only: Mulch Webview 122.0.6261.105
...
- standard build only: System Webview 120.0.6099.144
- microG build only: Mulch Webview 120.0.6099.193


18.12.2023

- ASB Security string 2023-12-05
- standard build only: System Webview 119.0.6045.134
- microG build only: Mulch Webview 120.0.6099.115
...
- standard build only:System Webview 115.0.5790.166 
- microG build only: Mulch Webview 116.0.5845.78
